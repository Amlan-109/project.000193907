...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ShowCase = __webpack_require__(329);
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this.saveLocation = function (location) {
	      var locations = _this.state.savedLocations;
	      locations.push(location);

	      _this.setState.apply(_this, _toConsumableArray(_this.state).concat([{
	...
	var Header = function (_React$Component) {
	  ...
	  function Header(props) {
	    ...
	    _this.toggleHamburger = function () {
	      _this.setState({
	        hamburger_open: !_this.state.hamburger_open
	      });
	    };
	  ...
	  _createClass(Header, [{
	    key: "render",
	    value: function render() {
	      var hamburger_class = "hamburger right";
	      var menu_class = "hamburger_menu";
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            "div",
	            { className: hamburger_class, onClick: this.toggleHamburger },
	            React.createElement("div", { className: "hamburger2" })
	          )
	        ),
	        React.createElement(
	          "div",
...
/***/ (function(module, exports) {
	...
	var ShowCase = function (_React$Component) {
	  ...
	  function ShowCase(props) {
	    ...
	    _this.fetchCityImage(_this.props.title).then(function (image) {
	      _this.setState({
	        image: image
	      });
	    });
	  ...
	  _createClass(ShowCase, [{
	    ...
	    value: function () {
	        ...
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                return _context.abrupt("return", fetch("https://api.unsplash.com/search/photos?page=1&query=" + city, {
	                  headers: {
	                    Authorization: "Client-ID 26c22dbaf3df569f2704283a647173f071f9a45d3c870ee216aac157278f474a"
	                  }
	      ...
	      function fetchCityImage(_x) {
	        return _ref.apply(this, arguments);
	      }

	      return fetchCityImage;
	    }()
	  }, {
	    key: "render",
	    value: function render() {
	      ...
	      return React.createElement(
	        "div",
	        { className: "showcase_container type1", style: { backgroundImage: "url(" + this.state.image + ")" } },
	        React.createElement(
	          "div",
	          { className: "showcase_text_container" },
	          React.createElement(
	            "h1",
	            { className: "showcase_title type1" },
	            this.props.title
	          ),
	          React.createElement(
	            "p",
	            { className: "showcase_description type1" },
	            this.props.description
	          ),
	          React.createElement(
	            "button",
	            { className: "add_button type1", onClick: function onClick() {
	                return _this2.props.onClick(_this2.props.title);
	              } },
	            "Add ",
	            this.props.title,
	            " to travel"
